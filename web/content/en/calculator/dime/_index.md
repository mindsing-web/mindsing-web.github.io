...
<label class="db mv2">Final expenses: $ <input class="ml2" type="number" name="final_expenses" id="final_expenses"></label>
...
<label class="db mv2">Income multiplier: <input class="ml2" type="number" name="income_multiplier" id="income_multiplier"></label>
...
<label class="db mv2">Months of rent: <input class="ml2" type="number" name="months_rent" id="months_rent"></label>
...
<label class="db mv2">Dependent education needs: $ <input class="ml2" type="number" name="dependent_education" id="dependent_education"></label>
