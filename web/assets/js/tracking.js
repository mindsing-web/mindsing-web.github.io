...
(function() {
  ...
  function getCurrentUser() {
    try {
      return localStorage.getItem('ga4_user_name') ||
   ...
   */
  window.Tracking.formInteraction = function(formType, action, additionalData) {
    var eventData = {
   ...
   * @param {Object} additionalData - Additional event data
   */
  window.Tracking.contentView = function(contentType, contentId, additionalData) {
    var eventData = {
      event: 'content_view',
